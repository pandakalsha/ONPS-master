...
<body class="templatemo-bg-image-2">
    ...
    <form class="demo" action="userinfo.jsp">
        <div id="wrapper">
            <section class="clearfix"></br></br>
                <h2>Validate Users</h2>
                    ...
                    <select name="userId">
                        ...
                        {
                            User u=(User)i.next();
                            if(u.getNew_().equals("Y"))
                            {
                        
                        %>


                        <option value="<%=u.getUserId() %>" ><% out.println(u.getName()); %></option>
                        <%
                            }
                        }
                        %>
                    ...
                    <input type="submit" value="Validate" class="btn btn-success pull-right">
                    <% 
                    %>
