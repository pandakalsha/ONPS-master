...
<body class="templatemo-bg-image-2">
    <div class="container">
        <div class="col-md-12">			
            <form class="form-horizontal templatemo-contact-form-1" role="form" action="candisave.jsp" method="post">
                ...
                <div class="form-group">
                    <div class="col-md-12">		          	
                        <label for="name" class="control-label">Voter Id(only 5 digits)</label>
                        <div class="templatemo-input-icon-container">

                            <input type="text" class="form-control" id="name" name="voteId" placeholder="" required>
                        </div>		            		            		            
                    </div>              
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <label for="website" class="control-label">Constituency&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Party</label>
                        <div class="demo">
                            <div id="wrapper">
                                    ...
                                    <select name="const">
                                     ...
                                     <select name="party">
                                        <%  Session s1 = HibernateUtil.getSessionFactory().openSession();
                                            Query q = s1.createQuery("from Party");
                                            List l1 = q.list();
                                            Iterator i1 = l1.iterator();
                                            while (i1.hasNext()) {
                                                Party p = (Party) i1.next();


                                        %>


                                        <option value="<%=p.getRegId() %>" ><% out.println(p.getName()); %></option>
                                        <%
