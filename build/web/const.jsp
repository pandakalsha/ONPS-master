                ...
                <h2>Choose Constituency</h2>
                    ...
                    <select name="const">
                        <%                            for (int i = 1; i <= 4; i++) {
                                ...
                                Constituency c=(Constituency) s.get(Constituency.class,i);
                                if (c.getState().getSid() == Integer.parseInt(request.getParameter("state"))) {
                        %>


                        <option value="<%=i%>" ><% out.println(c.getName()); %></option>
                        <%
                                }
                            }
                        %>
