...
<%
    ...
    Candidate c = (Candidate) s.get(Candidate.class, Integer.parseInt(request.getParameter("voterId")));
    //request.setAttribute("userid",u.getUserId());
    Constituency c1 = (Constituency) s.get(Constituency.class, c.getConstituency().getCid());
...
<body class="templatemo-bg-image-2">
    <div class="container">
        <div class="form-horizontal templatemo-contact-form-1">			
            <form action="candvalid.jsp?candId=<%=request.getParameter("voterId")%>" method="post" >
                <table width="496" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td height="51" colspan="2" valign="top"><font color="#FFFFFF" ><b>Voter Id</b></font></td>
                        <td colspan="2" valign="top"><font color="#FFFFFF" ><b><!--DWLayoutEmptyCell-->&nbsp;<%=c.getVoterId()%></b></font></td>
                    </tr>
                    <tr>
                        <td height="51" colspan="2" valign="top"><font color="#FFFFFF" ><b>Qualifications</b></font></td>
                        <td colspan="2" valign="top"><font color="#FFFFFF" ><b><!--DWLayoutEmptyCell-->&nbsp;<%=c.getQualification()%></b></font></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="53" colspan="2" valign="top"><font color="#FFFFFF" ><b>Assets</b></font></td>
                        <td colspan="2" valign="top"><font color="#FFFFFF" ><b><!--DWLayoutEmptyCell-->&nbsp;<%=c.getAsset()%></b></font></td>
                    </tr>
                    <tr>
                        <td height="2"></td>
                        <td width="54"></td>
